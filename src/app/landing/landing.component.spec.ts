...
//                   ],
//     imports:[ MenuModule,DialogModule, FormsModule, TreeModule,FieldsetModule, HttpModule ,RouterTestingModule, HttpClientModule, BrowserTransferStateModule ],
//     schemas: [ CUSTOM_ELEMENTS_SCHEMA ,NO_ERRORS_SCHEMA],
//     providers: [
//       SearchService, AppConfig, CommonVarService
//     ]
